...
import Kasia from './Kasia.js';
import DespachoUno from './Despacho/DespachoLegalUno.js';
import DespachoDos from './Despacho/DespachoLegalDos.js';
import EmpresaUno from './Empresa/EmpresaUno.js';
import EmpresaDos from './Empresa/EmpresaDos.js';
import EmpresaDesa from './Empresa/EmpresaDesa.js';
import MaterialidadUno from './Materialidad/MaterialidadUno.js';
import MaterialidadDos from './Materialidad/MaterialidadDos.js';
...
const DashBoard = (props) => {
    ...
    const kaleidoStatus = () => {    
        ...
        const url = 'https://console-us1.kaleido.io/api/v1/consortia/u1xsszi2gn/environments/u1bgxqcgm9/status';
        let config = { "headers" : {
    ...
    const stopNode = () => {
        ...
        console.log('Axe-stop day: ' + day + '  Hours : ' + hours + '</br>' + min + seg);
        if (hours === 20 && min === 57) 
        {
    ...
    //60000 1 mn 
    //-comentario temporal quitar despues setInterval(scheduledNodeStart, 180000 );
                                        ...
                                        <Grid container spacing={3}>
                                            ...
                                            <Grid item>Api nodo 3: <b>{node3}</b></Grid>*/}
                                              <Tooltip title="Cambiar estatus Environment ">
                                                        {nodes.state==='paused' ?
                                                    <Button  onClick={() => start()}> Axeleratum / Environment  : start
                                                        <LoopIcon/>
                                                    </Button> :  
                                                    <Button  onClick={() => stop()}>  Axeleratum / Environment  : stop
                                                        <LoopIcon/>
                                                    </Button>
                                            }</Tooltip>
